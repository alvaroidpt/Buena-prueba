import { ActionContext, ActionHandler, ActionRequest, ActionResponse, BaseRecord, BaseResource } from 'adminjs';
...
export declare const getFileFromRequest: (request: ActionRequest) => any;
